				...
				<header class="logo-env">
					...
					<div class="logo">
						<a href="dashboard-1.html" class="logo-expanded">
							<img src="/Admin/assets/images/logo@2x.png" width="80" alt="" />
						</a>
						
						<a href="dashboard-1.html" class="logo-collapsed">
							<img src="/Admin/assets/images/logo-collapsed@2x.png" width="40" alt="" />
						</a>
					</div>
		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					...
					<p class="description">List of widgets you can use with Xenon theme</p>
				</div>
...
<!--中间内容****************************************************************************************-->
	...
	<script src="/Admin/assets/js/xenon-widgets.js"></script>
	<script src="/Admin/assets/js/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
	<script src="/Admin/assets/js/jvectormap/regions/jquery-jvectormap-world-mill-en.js"></script>
